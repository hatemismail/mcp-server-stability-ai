...
export class FilesystemResourceClient extends ResourceClient {
    ...
    constructor(imageStorageDirectory) {
        super();
    ...
    async createResource(uri, base64image) {
        ...
        fs.writeFileSync(`${this.imageStorageDirectory}/${finalFilename}`, base64image, "base64");
