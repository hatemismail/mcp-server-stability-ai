...
// Implementation
export const generateImageSD35 = async (args, context) => {
    const { prompt, aspectRatio, negativePrompt, stylePreset, cfgScale, seed, model, outputFormat, outputImageFileName } = GenerateImageSD35ArgsSchema.parse(args);
