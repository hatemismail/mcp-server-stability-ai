...
// Implementation
export const generateImageUltra = async (args, context) => {
    const { prompt, aspectRatio, negativePrompt, stylePreset, seed, outputFormat, outputImageFileName } = GenerateImageUltraArgsSchema.parse(args);
