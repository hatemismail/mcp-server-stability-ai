	...
	inputSchema: {
		...
		properties: {
			imageFileUri: {
				type: "string",
				description:
					"The URI of the subject image. Accepts any https:// or http:// URL (presigned bucket URL, CDN URL, public image host — the server downloads bytes), a GCS object URL for this MCP's pre-staged bucket, or a file:// path on the server filesystem.",
			},
			backgroundPrompt: {
				type: "string",
			...
			backgroundReferenceUri: {
				type: "string",
				description:
					"Optional URI of a background-style reference image. Accepts any https:// or http:// URL (presigned bucket URL, CDN URL, public image host — the server downloads bytes), a GCS object URL for this MCP's pre-staged bucket, or a file:// path on the server filesystem.",
			},
			foregroundPrompt: {
				type: "string",
				description:
			...
			lightReferenceUri: {
				type: "string",
				description:
					"Optional URI of a lighting reference image. Accepts any https:// or http:// URL (presigned bucket URL, CDN URL, public image host — the server downloads bytes), a GCS object URL for this MCP's pre-staged bucket, or a file:// path on the server filesystem.",
			},
			lightSourceStrength: {
				type: "number",
