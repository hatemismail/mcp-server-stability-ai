...
export const generateImage = async (args, context) => {
    const { prompt, aspectRatio, negativePrompt, stylePreset, outputImageFileName, } = GenerateImageArgsSchema.parse(args);
